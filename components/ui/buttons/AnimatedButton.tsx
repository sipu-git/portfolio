...
const ButtonCrossArrow: React.FC<CrossArrowProps> = ({ text, icon: Icon }) => {
  return (
    <button className="group relative flex h-12 w-[170px] items-center justify-between 
         rounded-full 
        bg-linear-to-r dark:from-[#070e41] dark:to-[#263381] 
      ...
      <div className="relative h-9 w-9 overflow-hidden dark:bg-white bg-black rounded-full mr-1">
        <div className="absolute top-[0.7em] left-[-0.1em] 
            ...
            duration-400 group-hover:-translate-y-5 group-hover:translate-x-4">
